 ...
 * New function `SoilMoistureRegimeLevels()`: used for creating ordinal and nominal factors corresponding to Soil Moisture Regimes (https://github.com/ncss-tech/SoilTaxonomy/issues/34).
